...
class Locators():
    ...
    button_history_shop = (By.XPATH,
                           ".//li[@class='Account_listItem__35dAP']/a[@class='Account_link__2ETsJ text text_type_main-medium text_color_inactive']")  # Кнопка история заказов на странице Личного кабинета
